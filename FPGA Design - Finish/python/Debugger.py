...
class GUI(QMainWindow):
    ...
    def __init__(self):
        ...
        self.pushButton_FPGA_Program.clicked.connect(lambda: self.FPGA_Program(port))
        self.actionClose.triggered.connect(exit)
    
    def FPGA_Program(self,port):
        os.system('quartus_pgm -m JTAG -o p;MIPS.sof@1')
        print(Fore.GREEN)
        print('Finish program RTL design on FPGA.')
        print(Style.RESET_ALL)
